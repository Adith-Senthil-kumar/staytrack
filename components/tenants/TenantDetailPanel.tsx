            ...
            <ScrollView className="flex-1" contentContainerClassName="p-6">
              <View className="rounded-[14px] border border-border bg-surface p-[18px]">
                <View className="flex-row items-center gap-3">
                  ...
                  <View className="flex-1">
                    ...
                    <View className="mt-1 flex-row items-center gap-2">
                      <Text className="text-[12.5px] font-sans-semibold" style={{ color: tenant.foodPreference === 'veg' ? '#1E6F5C' : '#B5462F' }}>{tenant.foodPreference === 'veg' ? 'Vegetarian' : 'Non-Veg'}</Text>
                ...
                <View className="mt-4 flex-row gap-2">
                  {tenant.phone ? (
                    <Pressable onPress={() => Linking.openURL(`tel:${tenant.phone}`)} className="flex-1 flex-row items-center justify-center gap-2 rounded-[9px] bg-brand py-2.5 active:bg-brand-hover"><PhoneIcon size={14} color="#F4F1E7" /><Text className="text-[13px] font-sans-semibold text-[#F4F1E7]">{tenant.phone}</Text></Pressable>
                  ) : (
